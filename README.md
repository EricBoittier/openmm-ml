...
- Exported [metatomic](https://docs.metatensor.org/metatomic/) models, either through
  `MLPotential("metatomic")` or any [ASE Calculator](https://ase-lib.org/ase/calculators/calculators.html)
  including `MetatomicCalculator`.
